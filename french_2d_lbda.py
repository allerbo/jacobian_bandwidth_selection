...
np.save('data/french_2d_r2s_0_lbda_'+str(log10lbda),r2s_0)
np.save('data/french_2d_r2s_cv_lbda_'+str(log10lbda),r2s_cv)
np.save('data/french_2d_r2s_sil_lbda_'+str(log10lbda),r2s_sil)
np.save('data/french_2d_sigmas_0_lbda_'+str(log10lbda),sigmas_0)
np.save('data/french_2d_sigmas_cv_lbda_'+str(log10lbda),sigmas_cv)
np.save('data/french_2d_sigmas_sil_lbda_'+str(log10lbda),sigmas_sil)

np.save('data/french_2d_r2s_cv1_lbda_'+str(log10lbda),r2s_cv1)
np.save('data/french_2d_sigmas_cv1_lbda_'+str(log10lbda),sigmas_cv1)
