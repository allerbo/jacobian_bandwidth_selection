...
np.save('data/synth_r2s_0_n_'+str(n),r2s_0)
np.save('data/synth_r2s_cv_n_'+str(n),r2s_cv)
np.save('data/synth_r2s_sil_n_'+str(n),r2s_sil)
np.save('data/synth_sigmas_0_n_'+str(n),sigmas_0)
np.save('data/synth_sigmas_cv_n_'+str(n),sigmas_cv)
np.save('data/synth_sigmas_sil_n_'+str(n),sigmas_sil)

np.save('data/synth_r2s_cv1_n_'+str(n),r2s_cv1)
np.save('data/synth_sigmas_cv1_n_'+str(n),sigmas_cv1)
